...
(let ( (zenburn-fg		"#dcdccc")
       ...
       (zenburn-orange		"#f57900")
       (zenburn-tan		"#e9b96e")
       (zenburn-yellow		"#edd400")
       (zenburn-yellow-1	"#e0cf9f")
       (zenburn-yellow-2	"#d0bf8f")
       (zenburn-purple		"#ad7fa8")

       (zenburn-yellowgreen     "#8ae234")
  ...
  (custom-theme-set-faces
    ...
    `(comint-highlight-prompt ((t (:foreground ,zenburn-yellowgreen))))

    ;; compilation
    `(compilation-info ((t (:foreground ,zenburn-blue))))
    `(compilation-warning ((t (:foreground ,zenburn-yellow))))
    `(compilation-error ((t (:foreground ,zenburn-orange))))
    ...
    `(erc-current-nick-face ((t (:foreground "IndianRed"))))
    '(erc-dangerous-host-face ((t (:inherit font-lock-warning))))
    `(erc-direct-msg-face ((t (:foreground ,zenburn-yellow))))
    ...
    `(erc-notice-face ((t (:foreground ,zenburn-green-1))))
    ...
    `(font-lock-comment-face ((t (:foreground ,zenburn-orange :slant italic))))
    `(font-lock-comment-delimiter-face ((t (:foreground ,zenburn-orange))))
	`(font-lock-constant-face ((t (:foreground ,zenburn-blue))))
    `(font-lock-doc-face ((t (:foreground ,zenburn-orange))))
    `(font-lock-doc-string-face ((t (:foreground ,zenburn-blue+1))))
    `(font-lock-function-name-face ((t (:foreground ,zenburn-yellow))))
    `(font-lock-keyword-face ((t (:foreground ,zenburn-blue))))
    '(font-lock-negation-char-face ((t (:inherit 'zenburn-primary-1))))
    `(font-lock-preprocessor-face ((t (:foreground ,zenburn-tan))))
    `(font-lock-string-face ((t (:foreground ,zenburn-purple))))
    `(font-lock-type-face ((t (:foreground ,zenburn-yellowgreen))))
    `(font-lock-variable-name-face ((t (:foreground ,zenburn-fg))))
    `(font-lock-warning-face ((t (:foreground ,zenburn-yellowgreen))))
    `(font-lock-pseudo-keyword-face ((t (:foreground ,zenburn-blue))))
    ...
    ;; info
    `(info-xref ((t (:foreground ,zenburn-blue :weight bold))))
    ...
    ;; isearch
    `(isearch ((t (:foreground ,zenburn-bg-1 :background ,zenburn-yellow))))
    `(isearch-fail ((t (:foreground ,zenburn-fg :background ,zenburn-red-4))))
    `(lazy-highlight ((t (:foreground ,zenburn-yellow :background ,zenburn-purple))))
